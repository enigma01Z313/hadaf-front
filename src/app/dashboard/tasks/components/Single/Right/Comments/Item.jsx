...
import updateTaskComment from "@/app/lib/tasks/comments/update";
import removeTaskComment from "@/app/lib/tasks/comments/remove";
...
export default function Item({
  ...
  const handleCommentDelete = async () => {
    setLoading(true);
    await removeTaskComment(taskId, comment.id);
    setReloadList((state) => !state);
  };

  const handleCommentUpdate = async () => {
    setLoading(true);
    await updateTaskComment(taskId, comment.id, { content: val });
    setReloadList((state) => !state);
  };
